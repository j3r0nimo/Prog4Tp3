...
| @testing-library/user-event | Simula acciones de usuario   | Agrega herramientas para simular clicks, escritura, selección, etc., en las pruebas.                                                                                |
| @testing-library/jest-dom   | Comparadores personalizados  | Proporciona afirmaciones adicionales como toBeInTheDocument() o toHaveTextContent(), permitiendo que las pruebas sean mas fáciles de leer.                          |
...
| zod                         | Validación de esquema        | Una pequeña biblioteca para validar y analizar datos (a menudo utilizada para garantizar que las respuestas de la API o las entradas de formulario sean correctas). |
